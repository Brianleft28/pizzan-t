...
class ShinyHunterGUI(ctk.CTk):
    def __init__(self):
        ...
        self.ocr_label = ctk.CTkLabel(self.tab_general, text="OCR Retries:", font=ctk.CTkFont(weight="bold"))
        self.ocr_label.grid(row=1, column=0, padx=10, pady=5, sticky="w")
        ...
        ctk.CTkLabel(self.tab_ditto, text="Potion Key:", font=ctk.CTkFont(weight="bold")).grid(row=5, column=2, padx=10, pady=5, sticky="w")
        ...
        ctk.CTkButton(self.btns_row3, text="DEBUG", width=80, fg_color="#2c3e50", command=self.save_debug).pack(side="left", padx=2, expand=True, fill="x")
